...
num_frames = 0
print("#############################\n")
element = input("Input the word for which a custom gesture needs to be created: ")
print("\n#############################")
path="D:\\Ayush Gupta\\PYTHON\\code\\code\\train\\"+element
path2="D:\\Ayush Gupta\\PYTHON\\code\\code\\test\\"+element
os.mkdir(path)
os.mkdir(path2)
num_imgs_taken = 0
...
while True:
    ...
    #Time to configure the hand specifically into the ROI...
        ...
        cv2.putText(frame_copy, "Gesture for " + str(element), (200, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 500:
                cv2.imwrite(path +"\\" + str(num_imgs_taken) + '.jpg', thresholded)
            elif num_imgs_taken <= 600:
                cv2.imwrite(path2 +"\\" + str(num_imgs_taken-500) + '.jpg', thresholded)
            else:
                break
            num_imgs_taken +=1
        else:
